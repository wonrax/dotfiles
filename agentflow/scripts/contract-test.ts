    ...
    nodes: [
      {
        ...
        type: "review",
        label: "Judge",
        description: "deliberately violates its output contract, to exercise the correction loop",
        run:
          "Reply with exactly the word: hello. Output nothing else whatsoever, no verdicts, no explanations.",
      },
    ],
    edges: [],
  },
